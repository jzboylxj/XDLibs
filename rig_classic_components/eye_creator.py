...
class EyeCreator:
    ...
    def build_base_ctrl_group(self):
        for side in ["LF", "RT"]:
            ...
            for item in ["Up", "Low", "Inner", "Outer"]:
                ...
                temp_mp = core.utils.mp_node(node_name=temp_mp_name,
                ...
                base_ctrl_grp = core.utils.yellow_component(
    ...
    def build_base_loc_group(self):
        for side in ["LF", "RT"]:
            ...
            for item in ["Up", "Low", "Inner", "Outer"]:
                ...
                loc_grp = core.utils.jnt_or_control_grp(name=loc_name, object_type="locator")
                ...
                postion = None
                if item == "Outer":
                    postion = core.utils.point_on_curve_position(master_curve, 1.0)
                    pm.PyNode(ctrl).translate.connect(pm.PyNode(loc_name).translate)
                elif item == "Inner":
                    postion = core.utils.point_on_curve_position(master_curve, 0)
                    pm.PyNode(ctrl).translate.connect(pm.PyNode(loc_name).translate)
                elif item == "Low" or "Up":
                    postion = core.utils.point_on_curve_position(master_curve, 0.5)
        ...
        for side in ["LF", "RT"]:
            ...
            for vertical in ["Up", "Low"]:
                ...
                for index in range(1, seg + 1):
                    ...
                    mp = core.utils.mp_node(node_name=loc_name.replace("Loc", "MP"),
                    ...
                    if vertical == "Low":
                        ...
                        core.utils.custom_show_channel(
                            up_ctrl,
        ...
        for side in ["LF", "RT"]:
            ...
            for vertical in ["Up", "Low"]:
                ...
                for index in range(1, seg + 1):
                    ...
                    tweak_ctrl_grp = core.utils.yellow_component(name=tweak_ctrl,
                                                                 shape_type="sphere",
                    ...
                    mp = core.utils.mp_node(node_name=tweak_ctrl.replace("Ctrl", "MP"),
                    ...
                    ctrl_jnt_grp = core.utils.jnt_or_control_grp(name=ctrl_jnt, parent_node=tweak_jnt_group)
    ...
    def make_blink_work(self):
        for side in ["LF", "RT"]:
            ...
            core.utils.custom_show_channel(master_ctrl,
        ...
        for side in ["LF", "RT"]:
            ...
            for vertical in ["Up", "Low"]:
                ...
                for index in range(1, seg + 1):
                    ...
                    shape_ctrl = core.utils.jnt_or_control_grp(
                ...
                main_shape_ctrl_grp = core.utils.control_grp_have_joint(
        ...
        for side in ["LF", "RT"]:
            ...
            for vertical in ["Up", "Low"]:
                for index in range(1, seg + 1):
                    ...
                    core.utils.dm_node(node_name=jnt_dm,
    ...
    def build_eyeball_ctrl_group(self):
        for side in ["LF", "RT"]:
            ...
            aim_ctrl_grp = core.utils.jnt_or_control_grp(
    ...
    def build_aim_ctrl_group(self):
        ...
        for side in ["LF", "RT"]:
            ...
            eye_aim_ctrl_grp = core.utils.jnt_or_control_grp(
        ...
        main_aim_ctrl_grp = core.utils.jnt_or_control_grp(
